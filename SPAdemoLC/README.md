...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SPAdemoLC** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description : 'Analyzes demographic trend (SVD) and forecasts mortality in Japan and Taiwan using
Lee-Carter method.'

Keywords : 'demography, forecast, lee-carter-method, mortality, population, singular value, svd,
time-series'
...
Example : Plot of mortality and fertility
